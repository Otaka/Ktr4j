...
public class ScriptEvaluator {
    ...
    public ScriptEvaluator(byte[] buffer, String name, FunctionsManager functionsManager) {
        this(buffer, name, functionsManager, true);
    }
    
    public ScriptEvaluator(byte[] buffer, String name, FunctionsManager functionsManager, boolean scriptHasHeader) {
...
//dumpStack();
    ...
    private void storeState(int originalIp) {
        ...
        ScriptEvaluator closureEvaluator = new ScriptEvaluator(buffer, scriptName, functionsManager,false);
